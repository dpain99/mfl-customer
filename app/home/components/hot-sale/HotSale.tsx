...
export default function HotSale() {
  return (
    <div id="ribbon-container">
        ...
        <div className="ribbon">
          ...
          <div className="absolute -left-20 -top-20">
            ...
            >
              <path
                fill="#ffd469"
                d="m391.765 115.993l75.102-74.385c3.189-3.158 8.463-2.639 10.975 1.08l17.325 25.649c2.386 3.533 1.177 8.355-2.594 10.344l-92.427 48.736a7.162 7.162 0 0 1-9.275-2.326a7.16 7.16 0 0 1 .894-9.098m12.42 63.879a5.697 5.697 0 0 0 6.113 4.531l82.782-7.728a5.698 5.698 0 0 0 5.053-6.817l-4.939-24.129c-.716-3.498-4.436-5.484-7.741-4.131l-77.843 31.856a5.7 5.7 0 0 0-3.425 6.418m-61.809-87.844a5.698 5.698 0 0 0 7.526-1.118l53.071-64a5.7 5.7 0 0 0-1.247-8.394L381.173 4.947c-2.98-1.967-7.015-.741-8.395 2.553L340.26 85.069a5.698 5.698 0 0 0 2.116 6.959"
              />
              <path
                fill="#00b1ff"
                d="m218.4 479.836l-15.988 9.35c-12.996 7.6-29.692 3.226-37.292-9.77l-42.39-72.487c-7.6-12.996-3.226-29.692 9.77-37.292l15.988-9.35c12.996-7.6 29.692-3.226 37.292 9.77l42.39 72.487c7.601 12.996 3.226 29.692-9.77 37.292"
              />
              <path
                fill="#0096d1"
                d="m120.402 408.701l154.911-84.34l-105.898-165.808L29.384 262.586c-.903.577-38.751 35.207 2.814 100.288s88.204 45.827 88.204 45.827"
              />
              <path
                fill="#727272"
                d="M362.532 152.23c46.335 72.548 74.407 151.142 55.022 163.522c-19.385 12.38-78.885-46.14-125.22-118.689S217.928 45.922 237.312 33.541s78.885 46.14 125.22 118.689"
              />
              <ellipse
                cx="301.36"
                cy="191.299"
      ...
      <div id="star" className="ribbon-hidden">
        <div className="layer">
          <div className="star_text">HOT SALE</div>
        </div>
        <div className="layer">
          <div className="star outer rotate"></div>
        </div>
        <div className="layer">
          <div className="star inner rotate"></div>
        </div>
      </div>
    </div>
  );
