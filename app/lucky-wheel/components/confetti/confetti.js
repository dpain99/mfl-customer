export var confetti = {
  ...
  start: () => {}, //call to start confetti animation (with optional timeout in milliseconds, and optional min and max random confetti count)
  stop: () => {}, //call to stop adding confetti
